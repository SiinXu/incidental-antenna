  ...
  return (
    <LayoutBase {...props}>
      <main>
        ...
        {/* 产品特性 */}
        {siteConfig('STARTER_FEATURE_ENABLE', true, CONFIG) && <Features {...props} />}
        ...
        {/* 价格 */}
        {siteConfig('STARTER_PRICING_ENABLE', true, CONFIG) && <Pricing {...props} />}

        {/* 评价展示 */}
        {siteConfig('STARTER_TESTIMONIALS_ENABLE', true, CONFIG) && <Testimonials {...props} />}
